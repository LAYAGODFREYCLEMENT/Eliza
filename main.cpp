...
void print_title () {
    printf("\n\n");
    print_center("_________________ ELIZA  BY GROUP 3_________________");
    print_center("_________________CREATED BY GROUP MEMBERS:_________________");
    print_center("_________________LAYA GODFREY CLEMENT 19/U/0015/LCS_________________");	
    print_center("_________________ARIONNG BENARD 19/U.0011/LCS_________________");
    print_center("_________________WAYABA STRUGGLE 19/U/0015/LCS_________________");
    print_center("_________________ACOl STEOHEN 19/U/0111/LCS/PS_________________");
    print_center("_________________To stop Eliza, type 'bye'_________________");
    printf("\n\n");
